    ...
    private function doLogin()
    {
        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                // print_r($sql); die();
                // print_r($result_of_login_check); die();
                ...
                if ($result_of_login_check->num_rows == 1) {
                    ...
                    // var_dump($result_row->user_password);
                    // var_dump(password_hash($user_password, PASSWORD_DEFAULT));
                    // var_dump(password_verify($user_password, $result_row->user_password)); die();
